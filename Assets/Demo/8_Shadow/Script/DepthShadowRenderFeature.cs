...
public class DepthShadowRenderFeature : ScriptableRendererFeature
{
    ...
    private DepthShadowRenderPass depthShadow;

    public override void Create()
    {
        this.depthShadow = new DepthShadowRenderPass(
    ...
    public class DepthShadowRenderPass : ScriptableRenderPass
    {
        ...
        public DepthShadowRenderPass(RenderPassEvent renderPassEvent, Material material, RenderTexture renderTexture, RenderTexture renderTexture2)
        {
